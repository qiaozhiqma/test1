...
import com.fm.edusys.common.conf.KaptchaConfig;
import com.fm.edusys.common.support.KaptchaTextCreator;
...
import com.fm.SpringbootStart;
import com.fm.edusys.common.spring.SpringUtils;
import com.fm.edusys.mapper.auto.GeneratorMapper;
import com.fm.edusys.mapper.custom.TsysUserDao;
...
public class SpringbootTest {
   ...
   @Test
	public void test4(){
		String str = captchaProducerMath.createText();
	   String code = str.substring(0, str.lastIndexOf("@"));
	   String img = str.substring(str.lastIndexOf("@")+1);
